...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    var wolfie = new Werewolf('Dave')
    assert.equal(wolfie.hungry, false)
  });

  it('should become hungry after changing into werewolf form', function() {
    var wolfey = new Werewolf('Steve');
    assert.equal(wolfey.hungry, false);
    wolfey.change();
    assert.equal(wolfey.hungry, true)
  });

  it('should be able to eat(victim) once hungry', function() {
    var werewolf = new Werewolf('Greg');
    var victim = new Victim('Alan');
