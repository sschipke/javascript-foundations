...
describe('Medusa', function() {
  ...
  it('should unstone the the first victim and stone the 4th coming in', function() {
    // create medusa
    var medusa = new Medusa('Mimi');
    // create first victim
    var victim1 = new Person('Perseus');
    // create second victim
    var victim2 = new Person('Cassiopeia');
    // create third victim
    var victim3 = new Person('Sea Monster');
    // create fourth victim
    var victim4 = new Person('Andromeda');
